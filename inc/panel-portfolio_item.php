...
<section class="portfolio-item" data-category="<?php echo esc_attr($itemCategory); ?>">
          ...
          <ul class="portfolio-item__list portfolio-item__list--accolades">
            ...
            ?>
              <li class="portfolio-item__list-item flex flex-align-center">
                ...
                <?php if ($accoladeUrl) : ?><a href="<?php echo esc_url($accoladeUrl); ?>" target="_blank"><?php endif; ?>
                  <?php echo esc_html($accoladeName); ?>
          ...
          <ul class="portfolio-item__list">
            ...
            ?>
              <li class="portfolio-item__list-item flex flex-align-center">
                ...
                <?php if ($linkUrl) : ?><a href="<?php echo esc_url($linkUrl); ?>" target="_blank"><?php endif; ?>
                  <?php echo esc_html($linkName); ?>
            ...
            >
              <?php if (!$isImage) : ?>
                ...
                <?php if ($isVideo && str_contains($mediaSource, 'vimeo')) : ?>
                  <vimeo-video
                    src="<?php echo esc_url($mediaSource); ?>"
                    slot="media"
                    crossorigin
                    muted
                  ></vimeo-video>
                ...
                <?php elseif ($isAudio) : ?>
                  <audio
                    slot="media"
                    src="<?php echo esc_url($mediaSource['url']); ?>"
                  ></audio>
                <?php endif; ?>
                  <media-control-bar>
              ...
              <?php else : ?>
                <img src="<?php echo esc_url($mediaSource['url']); ?>" alt="<?php echo esc_attr($mediaSource['alt']) ?>" />
              <?php endif; ?>
            </li>
          <?php endwhile; ?>
        </ul>
